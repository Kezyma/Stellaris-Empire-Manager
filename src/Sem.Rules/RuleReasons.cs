...
public static class RuleReasons
{
    ...
    /// <summary>The plan already opens as many tradition trees as a game allows.</summary>
    public const string NoTraditionSlotsLeft = "sem.tradition.picks";
